                ...
                <div className="col-md-8">
                    <div className="card shadow-sm">
                        <div className="card-body text-center">
                            ...
                            <img 
                                src="../public/Img_Video/pasto.jpg"// Asegúrate de actualizar la ruta de la imagen
                                alt="Paisaje Pastuso" 
                            ...
                            <img 
                                src="../public/Img_Video/Lajas.jpg"// Asegúrate de actualizar la ruta de la imagen
                                className="img-fluid rounded my-4" 
                                alt="" 
